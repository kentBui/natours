...
const logout = async () => {
  try {
    _axios.default.defaults.headers.withCredentials = true;
    const res = await _axios.default.get("http://127.0.0.1:2000/api/v1/users/logout");
    console.log(res.data);

    if (res.data.status === "success") {
      (0, _alert.showAlert)("success", res.data.message); // location.reload(true);
...
exports.updatePasswordData = exports.updateSettingData = void 0;
...
// update data
const updateSettingData = async (name, email) => {
  try {
    _axios.default.defaults.withCredentials = true;
    const res = await _axios.default.post("http://127.0.0.1:2000/api/v1/users/updateMe", {
      name,
      email
    });
    console.log(res);
    ...
    if (res.data.status === "success") {
      (0, _alert.showAlert)("success", "Update data successful");
    }
  } catch (error) {
    (0, _alert.showAlert)("error", error.response.data.message);
  }
...
exports.updateSettingData = updateSettingData;

const updatePasswordData = async (oldPassword, newPassword, newPasswordConfirm) => {
  try {
    _axios.default.defaults.withCredentials = true;
    const res = await _axios.default.post("http://127.0.0.1:2000/api/v1/users/updateMyPassword", {
      oldPassword,
      newPassword,
      newPasswordConfirm
    });
    ...
    if (res.data.status === "success") {
      (0, _alert.showAlert)("success", "Update password successful");
    }
  } catch (error) {
    (0, _alert.showAlert)("error", error.response.data.message);
  }
...
const userPassForm = document.querySelector(".form-user-settings"); // delegation
...
if (logoutEl) {
  logoutEl.addEventListener("click", _auth.logout);
}
...
if (userDataForm) {
  userDataForm.addEventListener("submit", e => {
    ...
    const email = document.getElementById("email").value;
    (0, _updateSettings.updateSettingData)(name, email);
  });
}
...
if (userPassForm) {
  userPassForm.addEventListener("submit", async e => {
    ...
    await (0, _updateSettings.updatePasswordData)(oldPassword, newPassword, newPasswordConfirm);
...
},{"core-js/modules/web.timers.js":"../../node_modules/core-js/modules/web.timers.js","core-js/modules/web.immediate.js":"../../node_modules/core-js/modules/web.immediate.js","core-js/modules/web.dom.iterable.js":"../../node_modules/core-js/modules/web.dom.iterable.js","./auth":"auth.js","./updateSettings":"updateSettings.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
